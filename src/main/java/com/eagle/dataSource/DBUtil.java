...
public class DBUtil {
	...
	private static void initConnectInfo(){
		...
		/**xml方式**/
		List<Element> elements = loder.getRootElements(environment,DATASOURCE_TAG,PROPERTY_TAG);
		/**properties文件的方式**/
		Element element = loder.getRootElements(environment,DATASOURCE_TAG,CONTEXTPATH_TAG).get(0);
